...
<body>
	...
	<form action="empresa" method="post">
		...
		<table>
			<tr>
				<td>Nombre:</td>
				<td><input type="text" name="nombre" value="${empleado.nombre}"
					required></td>
			</tr>
			<tr>
				<td>Sexo:</td>
				<td><input type="text" name="sexo" value="${empleado.sexo}"
					required pattern="[MmFf]" title="Por favor, introduce solo 'M' o 'F' (mayúsculas o minúsculas)."></td>
			</tr>
			<tr>
				<td>Categoria:</td>
				<td><input type="text" name="categoria"
					value="${empleado.categoria}" required pattern="^[1-9]|10$" title="Por favor, introduce un número del 1 al 10."></td>
			</tr>
			<tr>
				<td>Años:</td>
				<td><input type="text" name="anyos" value="${empleado.anyos}"
					required pattern="^(0*[1-9]\d*(\.\d+)?|0*\.\d*[1-9]\d*)$" title="Por favor, introduce un número mayor que 0."></td>
			</tr>
